...
class UNetpp3_Transformer(nn.Module):
    def __init__(self, num_classes, input_channels=30, n_patches=7, n_blocks=2, n_heads=2):
        ...
        # Register positional embeddings as a buffer so they move with .to(device)
        # and are persisted in state_dict alongside the trained weights.
        self.register_buffer(
            'positional_embeddings',
            self.get_positional_embeddings(30, 1024),
        )
