...
def main():
    ...
    train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers, persistent_workers=True, pin_memory=ON_GPU)
    ...
    for epoch in range(start_epoch, args.max_epochs):
        ...
        # --------------a. training--------------------------------
        model.train()
        trainloss = run_epoch(data_load(train_loader, device=DEVICE), model, SimpleLossCompute(model.generator, criterion, model_opt))
